...
const (
	...
	SFIOR_PSR2      = 0x2  // Prescaler reset
	SFIOR_PSR2_Msk  = 0x2  // Prescaler reset
...
const (
	...
	MCUCR_SM2      = 0x80 // Sleep Mode Select
	MCUCR_SM_Msk   = 0xb0 // Sleep Mode Select
	MCUCR_SE       = 0x40 // Sleep Enable
	MCUCR_SE_Msk   = 0x40 // Sleep Enable
...
const (
	...
	UBRR_UBRR_Msk = 0xfff // USART Baud Rate bits
)
