...
const (
	...
	MCUCR_BODS      = 0x40 // BOD Power Down in Sleep
	MCUCR_BODS_Msk  = 0x40 // BOD Power Down in Sleep
	MCUCR_BODSE     = 0x20 // BOD Power Down in Sleep Enable
	MCUCR_BODSE_Msk = 0x20 // BOD Power Down in Sleep Enable
